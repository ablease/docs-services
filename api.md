...
### Changes Since v2.10 <a name="since-v2.10"</a>
...
## API Version Header <a name="version-header"</a>
...
## Catalog Management <a name="catalog-management"</a>
...
### Adding a Broker to the Platform <a name="adding-broker-platform"</a>
...
## Synchronous and Asynchronous Operations <a name="synchronous-asynchronous"</a>
...
### Asynchronous Operations <a name="asynchronous-operations"</a>
...
## Polling Last Operation <a name="polling-last-operation"</a>
...
### Polling Interval and Duration <a name="polling-interval-and-duration"</a>
...
## Updating a Service Instance <a name="updating-service-instance"</a>
...
### Types of Binding <a name="types-of-binding"</a>
...
## Deprovisioning <a name="deprovisioning"</a>
...
## Broker Errors <a name="broker-errors"</a>
